...
public class Array {
	...
	//Ejercicio 1: Crea un array con un tamaño de 5, asignale los valores numéricos manualmente (los que tu quieras) y muestralos por pantalla.
	...
	//Ejercicio 2: Crea un método que genere un array de enteros que se rellenen de 0 hasta el valor pasado por parámetro y lo muestre por pantalla.
	...
	//Ejercicio 3: Crea un método que genere un array de enteros que se rellenen del valor pasado por parámetro  hasta 0 y lo muestre por pantalla.
	...
	//Ejercicio 4: Crea un método que pasándole como parámetro un array devuelva los valores multiplos de dos y lo muestre por pantalla.
	...
	//Ejercico 5: Crea un método que devuelva un array con las posiciones pares de un array pasado por parámetro y lo muestre por pantalla.
	
	//Pos  0  1  2  3  4  5  6  
	//    {1, 5, 4, 6, 3, 0, 8, } tamaño = 7
	...
	public static int [] generarArray5(int [] array) {
		...
		if(array.length%2 ==0) {
			tamañoArray = array.length/2 ;
		} else {
			tamañoArray = (array.length/2) +1;
		}
		
		int [] pospares = new int [tamañoArray];
		int j = 0;
	...
	//Ejercicio 6: Crea un método que devuelva un array que sera la combinación de otros dos pasado por parámetro y lo muestre por pantalla.
	
	//nombre = {"Juan", "Pedro", }
	//apellido = {"Suarez", "Monzon",}
	//combinacion = {null, null, null, null} Comienza vacio
	//combinacion = {juan, pedro, null, null} Se ha añadido nombre dentro de vacio
	...
	//Ejercicio 7: Crea un método que pasándole un entero y un array devuelva otro array con valores superior al entero pasado y muestre por pantalla el resultado
	...
	public static int [] generarArray7(int entero, int [] array) {
		...
		int [] superior = new int [tamañosup];
		int j = 0;
		for(int i = 0; i < array.length; i++) {
			if(entero < array[i]) {
				superior[j]=array[i];
	...
	//Ejercicio 8: Crea un método que pasándole un array de enteros, me lo devuelva ordenado y muestre por pantalla el resultado.
	...
	//Ejercicio 9: Crear un método que pasándole como parámetro un array y un valor del mismo tipo me devuelva si está o no (si está devolverá true, en caso contrario false)
	...
	public static boolean containArray(String [] param1, String param2){
		...
		//Comprobamos de izquierda a derecha,es decir, desde el tamaño final del array hasta las posicion 0
		...
		/*
		//Comprobamos de derecha a izquierda,es decir, desde la posicion 0 hasta el tamaño final del array
