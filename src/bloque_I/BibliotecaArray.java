...
public class BibliotecaArray {
	...
	/*
	 * 8) crea un m�todo que elimine un elemento de una posici�n dada de un array
	 * */
	// 0,1,2,3,4,5
	//{2,4,6,7,1,9} tam 6
	//pos 3
	...
	/*
	 * 9) Crea un m�todo que ordene los elemento de un array. Tendr� un par�metro boolean, si este es true, lo ordenar� de mayor a menor, si es falso
	 * de menor a mayor
	 * */
	...
	/*
	 * 10) crea un metodo que guarde dentro de un array un elemento en la posici�n que se le indica. Si la izquierda no hay valores se rellena con 0
	 * */
	...
	/*
	 * 11)Crea un m�todo que devuelva las letras del DNI. Las letras del DNI  se obtiene como el resto de dividir el n�mero del DNI entre 23,
	...
	/*
	 * 12) Crea un m�todo que compare dos array y que devuelva true si son iguales o false si no lo son
	 * */
	...
	/*
	 * 13) Crea un m�todo que devuelva una sub-array de un array dado. El m�todo recibir� adem�s dos par�metros, que determine el principio y 
	 * el fin de los valores que debe devolver el m�todo
	 * Por ejemplo:
	...
	public static int [] arrayDado(int [] array, int ini, int fin) {
		...
		//Contador para saber el tama�o de lo que extraeremos en el subArray
		int contador = 0;
		//ini=2 fin=4
		//ite 1 i = 2; cont = 0
		//ite 2 i = 3; cont = 1
		...
		Si inicia fuera de una posicion que no tiene el array, devuelve un array vacio del tama�o entre ini y fin
